    ...
    <>
      <div className="space-y-4 pb-6">
            ...
            <div className="px-4 py-4">
              <div className="flex items-center gap-3 mb-3">
                <img 
                  src={appIcon} 
                  alt="xpense logo" 
                  className="w-[60px] h-[60px] rounded-[14px] flex-shrink-0 shadow-lg" 
                />
                <div className="flex-1">
                  <div className="text-[22px] font-bold text-white tracking-[-0.41px]">xpense</div>
        ...
        <div>
          ...
          <div className="bg-[#1C1C1E] rounded-[10px] overflow-hidden">
            <div className="px-4 py-3 flex items-center gap-3" style={{ minHeight: '44px' }}>
              ...
              <div className="flex-1">
                <div className="text-[17px] text-white tracking-[-0.41px]">Data Size</div>
        ...
        <div>
          ...
          <div className="bg-[#1C1C1E] rounded-[10px] overflow-hidden">
            <button 
              ...
              className="w-full px-4 py-3 flex items-center gap-3 active:bg-[#2C2C2E] transition-colors relative"
              style={{ minHeight: '44px' }}
            >
              <div className="w-[29px] h-[29px] rounded-[7px] bg-[#007AFF] flex items-center justify-center flex-shrink-0">
                <Download size={16} strokeWidth={2.5} className="text-white" />
              </div>
              <div className="flex-1 text-left">
                <div className="text-[17px] text-white tracking-[-0.41px]">Export to CSV</div>
              ...
              {exportSuccess ? (
                ...
                <ChevronRight size={20} strokeWidth={2} className="text-[#C7C7CC]" />
              )}
            </button>
            <div className="h-[0.5px] bg-[#38383A] ml-[57px]"></div>

            <button 
              onClick={handleImportData}
              className="w-full px-4 py-3 flex items-center gap-3 active:bg-[#2C2C2E] transition-colors"
              style={{ minHeight: '44px' }}
            >
              <div className="w-[29px] h-[29px] rounded-[7px] bg-[#007AFF] flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex-1 text-left">
                <div className="text-[17px] text-white tracking-[-0.41px]">Import from CSV</div>
            ...
            <button 
              ...
              style={{ minHeight: '44px' }}
            >
              <div className="w-[29px] h-[29px] rounded-[7px] bg-[#FF3B30] flex items-center justify-center flex-shrink-0">
        ...
        <div>
          ...
          <div className="bg-[#1C1C1E] rounded-[10px] overflow-hidden">
            ...
            >
              ...
              <span className="flex-1 text-left text-[17px] text-white tracking-[-0.41px]">Currency</span>
            ...
            <button 
              ...
              style={{ minHeight: '44px' }}
            >
              <div className="w-[29px] h-[29px] rounded-[7px] bg-[#FF9500] flex items-center justify-center flex-shrink-0">
                <Calendar size={16} strokeWidth={2.5} className="text-white" />
              </div>
              <span className="flex-1 text-left text-[17px] text-white tracking-[-0.41px]">Date Format</span>
            ...
            <button 
              ...
              style={{ minHeight: '44px' }}
            >
              <div className="w-[29px] h-[29px] rounded-[7px] bg-[#5856D6] flex items-center justify-center flex-shrink-0">
                <Key size={16} strokeWidth={2.5} className="text-white" />
              </div>
              <span className="flex-1 text-left text-[17px] text-white tracking-[-0.41px]">Gemini API Key</span>
        ...
        <div>
          ...
          <div className="bg-[#1C1C1E] rounded-[10px] overflow-hidden">
            <button className="w-full px-4 py-3 flex items-center gap-3 active:bg-[#2C2C2E] transition-colors" style={{ minHeight: '44px' }}>
              <div className="w-[29px] h-[29px] rounded-[7px] bg-[#5856D6] flex items-center justify-center flex-shrink-0">
                <Info size={16} strokeWidth={2.5} className="text-white" />
              </div>
              <span className="flex-1 text-left text-[17px] text-white tracking-[-0.41px]">Version</span>
            ...
            <button 
              ...
              style={{ minHeight: '44px' }}
            >
              <div className="w-[29px] h-[29px] rounded-[7px] bg-[#FF2D55] flex items-center justify-center flex-shrink-0">
                <HelpCircle size={16} strokeWidth={2.5} className="text-white" />
              </div>
              <span className="flex-1 text-left text-[17px] text-white tracking-[-0.41px]">Help & Support</span>
              <ChevronRight size={20} strokeWidth={2} className="text-[#C7C7CC]" />
            </button>
            <div className="h-[0.5px] bg-[#38383A] ml-[57px]"></div>
            ...
            <button 
              ...
              style={{ minHeight: '44px' }}
            >
              <div className="w-[29px] h-[29px] rounded-[7px] bg-[#8E8E93] flex items-center justify-center flex-shrink-0">
                <Shield size={16} strokeWidth={2.5} className="text-white" />
              </div>
              <span className="flex-1 text-left text-[17px] text-white tracking-[-0.41px]">Privacy Policy</span>
              <ChevronRight size={20} strokeWidth={2} className="text-[#C7C7CC]" />
            </button>
          </div>
        </div>
      ...
      >
        {CURRENCIES.map((currency, index) => (
          <React.Fragment key={currency.code}>
            <button onClick={() => handleCurrencySelect(currency.code)} className="w-full px-4 py-3 flex items-center gap-3 active:bg-[#2C2C2E] transition-colors" style={{ minHeight: '44px' }}>
              <div className="flex-1 text-left">
                <div className="text-[17px] text-white tracking-[-0.41px] font-medium">{currency.code}</div>
            ...
            {index < CURRENCIES.length - 1 && <div className="h-[0.5px] bg-[#38383A] ml-4"></div>}
          </React.Fragment>
        ))}
      </BottomSheet>
      ...
      <BottomSheet
        ...
        isClosing={isClosingDateFormat}
        onClose={handleCloseDateFormatPicker}
        title="Date Format"
        maxHeight="70vh"
      >
        {DATE_FORMATS.map((format, index) => (
          <React.Fragment key={format.id}>
            <button onClick={() => handleDateFormatSelect(format.id)} className="w-full px-4 py-3 flex items-center gap-3 active:bg-[#2C2C2E] transition-colors" style={{ minHeight: '44px' }}>
              <div className="flex-1 text-left">
                <div className="text-[17px] text-white tracking-[-0.41px] font-medium">{format.label}</div>
            ...
            {index < DATE_FORMATS.length - 1 && <div className="h-[0.5px] bg-[#38383A] ml-4"></div>}
          </React.Fragment>
        ))}
      </BottomSheet>
      ...
      <BottomSheet
        ...
        isClosing={isClosingHelpSupport}
        onClose={handleCloseHelpSupport}
        title="Help & Support"
        maxHeight="80vh"
      >
        <div className="px-4 py-6 space-y-6">
          <div>
            <h4 className="text-[17px] font-semibold text-white tracking-[-0.41px] mb-3">Developer</h4>
            <div className="bg-[#2C2C2E] rounded-[10px] p-4">
              <p className="text-[15px] text-white tracking-[-0.24px] mb-2"><span className="font-semibold">Bhavesh Patil</span></p>
              <p className="text-[13px] text-[#8E8E93] tracking-[-0.08px]">@iambhvsh</p>
            </div>
          </div>
          <div>
            <h4 className="text-[17px] font-semibold text-white tracking-[-0.41px] mb-3">Contact</h4>
            <a href="mailto:iambhvshh@outlook.com" className="block bg-[#2C2C2E] rounded-[10px] p-4 active:bg-[#3C3C3E] transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-[15px] text-white tracking-[-0.24px] font-medium">Email</p>
      ...
      <BottomSheet
        ...
        isClosing={isClosingPrivacyPolicy}
        onClose={handleClosePrivacyPolicy}
        title="Privacy Policy"
        maxHeight="80vh"
      >
        <div className="px-4 py-6">
          <div className="bg-[#2C2C2E] rounded-[10px] p-4 space-y-4">
            <div>
              <h4 className="text-[15px] font-semibold text-white tracking-[-0.24px] mb-2">Information</h4>
            ...
            <div className="h-[0.5px] bg-[#38383A]"></div>
            <div>
              <h4 className="text-[15px] font-semibold text-white tracking-[-0.24px] mb-2">Local Storage Only</h4>
            ...
            <div className="h-[0.5px] bg-[#38383A]"></div>
            <div>
              <h4 className="text-[15px] font-semibold text-white tracking-[-0.24px] mb-2">AI Features</h4>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-[#1C1C1E] rounded-[14px] w-full max-w-[340px] overflow-hidden animate-scale-in shadow-2xl">
            <div className="px-4 pt-5 pb-4">
              <h3 className="text-[17px] font-semibold text-white tracking-[-0.41px] mb-2 text-center">Gemini API Key</h3>
              ...
              <div className="relative mb-3">
                <input 
                  ...
                  className="w-full px-4 py-3 bg-[#2C2C2E] text-white rounded-[10px] text-[15px] tracking-[-0.24px] border-none outline-none focus:ring-2 focus:ring-[#007AFF] pr-16" 
                  autoFocus 
                />
                {apiKeyInput && (
                  <button
            ...
            <div className="border-t border-[#38383A]">
              <div className="grid grid-cols-2">
                {hasApiKey && <button onClick={handleRemoveApiKey} className="py-3 text-[17px] font-semibold text-[#FF3B30] tracking-[-0.41px] active:bg-[#2C2C2E] transition-colors border-r border-[#38383A]">Remove</button>}
                <button onClick={() => setShowApiKeyModal(false)} className={`py-3 text-[17px] font-semibold text-[#8E8E93] tracking-[-0.41px] active:bg-[#2C2C2E] transition-colors ${hasApiKey ? 'border-r border-[#38383A]' : ''}`}>Cancel</button>
                <button onClick={handleSaveApiKey} disabled={!apiKeyInput.trim()} className="py-3 text-[17px] font-semibold text-[#007AFF] tracking-[-0.41px] active:bg-[#2C2C2E] transition-colors disabled:opacity-50 disabled:cursor-not-allowed">Save</button>
              </div>
            </div>
          </div>
        </div>
