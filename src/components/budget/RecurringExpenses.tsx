  ...
  return (
    <div className="space-y-4">
      ...
      <div className="px-4 flex items-center justify-between">
        <h3 className="text-[28px] font-bold text-white tracking-[-0.41px]">
          Recurring Expenses
        </h3>
        {!isAdding && (
          <button
            ...
            className="w-11 h-11 rounded-full bg-[#007AFF] flex items-center justify-center active:scale-95 transition-transform"
          >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    className="w-9 h-9 rounded-full bg-[#3A3A3C] flex items-center justify-center active:scale-95 transition-transform"
                    title="Skip next"
                  >
