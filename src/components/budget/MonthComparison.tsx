...
export const MonthComparison: React.FC<MonthComparisonProps> = ({ comparison }) => {
  ...
  return (
    <div className="bg-[#1C1C1E] md:bg-white rounded-[28px] p-6 shadow-sm">
      <h3 className="text-[20px] font-bold text-white md:text-[#000000] tracking-[-0.41px] mb-4">
        Month Comparison
      </h3>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="text-[22px] font-bold text-white md:text-[#000000] tracking-[-0.41px]">
        ...
        <div className="h-[0.5px] bg-[#38383A] md:bg-[#C6C6C8]" />
